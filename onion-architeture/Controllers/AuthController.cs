...
namespace onion_architecture.Controllers
{
    public class AuthController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginModel model)
        {
            ...
            var response = await _httpClient.PostAsJsonAsync("https://localhost:7220/api/Auth/Login", model);
        ...
        public async Task<IActionResult> Register(RegisterModel model)
        {
            ...
            var response = await _httpClient.PostAsJsonAsync("https://localhost:7220/api/Auth/Register", model);
            if (response.IsSuccessStatusCode)
            {
